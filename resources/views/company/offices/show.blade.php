...
@section('dashboard-content')
    ...
    <div class="grid-x align-center">
        <div class="cell large-8 medium-10 small-12">
            <header>
                <h3>
                    <i class="fa fa-user"></i> Office - {{ $office->name }} (#{{ $office->batch_id }})
                    <a class="button primary" href="{{ route('offices.edit', ['company' => $company->name, 'office' => $office->id]) }}"><i class="fa fa-pencil"></i> edit</a>
                </h3>
            </header>
