    ...
    <div class="grid-x login-container align-center align-middle">
        <div class="cell large-4 medium-8 small-12">
            <div class="form-wrapper">
                <header>
                    <h3 class="text-center">Welcome To Homacare</h3>
                </header>
                <section class="form-container">
                    <form action="{{ route('login') }}" method="post" class="login-form">
                        ...
                        <a href="{{ action('Auth\ForgotPasswordController@showLinkRequestForm') }}" class="button alert float-right forgot-password">Forgot Password</a>
                    </form>
