...
@section('dashboard-content')
    <header>
        <h3><i class="fa fa-gear"></i> General Settings</h3>
    ...
    <div class="create-user-form-wrapper">
        <div class="grid-x">
            <div class="cell">
                ...
                <form action="{{ route('settings.general.update', ['company' => $company->name]) }}" method="post">
                    {{ csrf_field() }}
                    {{ method_field('put') }}
                    <div class="grid-x grid-padding-x align-center">
                        <div class="cell large-4">
                            ...
                            <label for="name">Company Name
                                <div class="input-group">
                                    ...
                                    <input class="input-group-field" id="name" type="text" name="name" placeholder="Company Name" value="{{ $company->name }}" disabled>
                                </div>
                            </label>
                            ...
                            <label for="ac-number"> Account Number
                                <div class="input-group">
                                    ...
                                    <input class="input-group-field" id="ac-number" type="text" name="account_number" placeholder="Account Number"  value="{{ $company->account_number }}" disabled>
                                </div>
                            </label>
                        ...
                        <div class="cell large-4">
                            ...
                            <button class="button success float-right input-margin-fix"><i class="fa fa-plus"></i> save changes</button>
                        </div>
                    </div>
