    ...
    <div class="create-user-form-wrapper">
        <div class="grid-x">
            <div class="cell">
                ...
                <form action="{{ route('managers.store', ['company' => $company->name]) }}" method="post">
                    {{ csrf_field() }}
                    <div class="grid-x grid-padding-x align-center">
                        <div class="cell large-4">
                            ...
                            <button class="button success float-right input-margin-fix"><i class="fa fa-plus"></i> Create New Manager</button>
                        </div>
                        <div class="cell large-4">
                            @if ($errors->any())
